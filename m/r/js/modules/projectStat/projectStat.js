$(function () {
    var t = new Vue({
        el: "#bodydiv",
        data: {
            //url:    "//localhost/rest/project/stat",
            url:   "/rest/project/stat",
            cmdtype: "projectStatPage",
            ...
            loadStatList: function (event) {
                ...
                req.success = function (data) {
                    ...
                    if (self.statList.length > 0) {
                        self.clickStatTr(event,self.statList[0]);
        ...
        mounted: function (event) {
            this.statType = U.urlParamObj['statType'];
            this.loadStatTree();
            this.loadStatList();
         }
